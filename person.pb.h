...
class Person PROTOBUF_FINAL :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Person_PhoneNumber >*
      mutable_phone();
  private:
  const ::Person_PhoneNumber& _internal_phone(int index) const;
  ::Person_PhoneNumber* _internal_add_phone();
  public:
...
inline const ::Person_PhoneNumber& Person::_internal_phone(int index) const {
...
inline ::Person_PhoneNumber* Person::_internal_add_phone() {
  return phone_.Add();
}
